...
public class Sweater extends AbstractClothes {
  ...
  public Sweater(Season season, String countryOfManufacture, String brandName, double priceInUah, Gender genderCategory,
      String material, String color, int size, int itemId, int ageGroupInYears, int heightInCentimetres,
      String clothesStyle, String printType, String knittingType, double neckHeightInCentimetres) {
