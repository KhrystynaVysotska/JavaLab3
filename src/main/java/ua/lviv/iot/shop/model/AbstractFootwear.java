...
public abstract class AbstractFootwear extends AbstractGoodsForKids {
    ...
    public String getHeaders() {
        return super.getHeaders() + "," + "footwearStyle, soleMaterial, soleHeightInMilimetres, liningMaterial";
    }

    public String toCSV() {
        return super.toCSV() + "," + footwearStyle + "," + soleMaterial + "," + soleHeightInMilimetres + ","
                + liningMaterial;
    }
}
