...
public abstract class BaseShopManagerTest {
    ...
    public void createSweaters() {
        ...
        sweaters.add(new Sweater(Season.AUTUMN, "Chinese", "Chicco", 450, Gender.BOY, "cotton", "blue", 38, 1543, 6,
                116, "casual", "none", "machine tool", 0.0));
        sweaters.add(new Sweater(Season.WINTER, "Ukraine", "TopHat", 560, Gender.GIRL, "knitwear", "white", 36, 3654,
