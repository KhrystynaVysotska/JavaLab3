...
public abstract class BaseShopManagerTest {
	...
	public void createSweaters() {
		...
		sweaters.add(new Sweater(Season.AUTUMN, "Chinese", "Chicco", 450, Gender.BOY, "cotton", "blue", 38, 1, 6, 116,
				"casual", "none", "machine tool", 0.0));
		sweaters.add(new Sweater(Season.WINTER, "Ukraine", "TopHat", 560, Gender.GIRL, "knitwear", "white", 36, 2, 12,
				156, "casual", "flower", "hand knitting", 3));
		sweaters.add(new Sweater(Season.AUTUMN, "Sweden", "H&M", 340, Gender.BOY, "cotton", "haki", 39, 3, 7, 122,
				"casual", "dragon", "machine tool", 0.0));
		sweaters.add(new Sweater(Season.AUTUMN, "Ukraine", "Flash", 490, Gender.GIRL, "wool", "grey", 35, 4, 9, 134,
